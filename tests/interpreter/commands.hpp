...
std::vector<std::shared_ptr<ASTNode>> getNormalFlowCode() {
    return {
...
std::vector<std::shared_ptr<ASTNode>> getFunctionClosuresCode() {
    return {
...
std::vector<std::shared_ptr<ASTNode>> getCalculationsCode() {
    return {
        ASSIGNVAR("var", INT(1)),
...
std::vector<std::shared_ptr<ASTNode>> getControlFlowTestCode() {
    return {
        // Initialize counter
        ASSIGNVAR("i", INT(0)),
...
std::vector<std::shared_ptr<ASTNode>> getRecursionTestCode() {
    return {
        FUNC("fact", STRARR("n"),
            CODE(
                IF(LEQ(VAR("n"), INT(1)),
...
std::vector<std::shared_ptr<ASTNode>> getLogicalOperatorsTestCode() {
    return {
...
std::vector<std::shared_ptr<ASTNode>> getNestedClosureTestCode() {
    return {
        FUNC("outer", STRARR("x"),
            CODE(
...
std::vector<std::shared_ptr<ASTNode>> getNestedIfElseTestCode() {
    return {
...
std::vector<std::shared_ptr<ASTNode>> getNestedLoopTestCode() {
    return {
        ASSIGNVAR("i", INT(0)),
...
std::vector<std::shared_ptr<ASTNode>> getNoArgFunctionTestCode() {
    return {
