...
std::shared_ptr<ASTNode> expressionTest1Result() {
    return CODE(
...
std::shared_ptr<ASTNode> expressionTest2Result() {
    return CODE(
...
std::shared_ptr<ASTNode> expressionTest3Result() {
    return CODE(
...
std::shared_ptr<ASTNode> expressionTest4Result() {
    return CODE(
...
std::shared_ptr<ASTNode> expressionTest5Result() {
    return CODE(
...
std::shared_ptr<ASTNode> expressionTest6Result() {
    return CODE(
...
std::shared_ptr<ASTNode> expressionTest7Result() {
    return CODE(
...
std::shared_ptr<ASTNode> expressionTest8Result() {
    return CODE(
...
std::shared_ptr<ASTNode> expressionTest9Result() {
    return CODE(
...
std::shared_ptr<ASTNode> expressionTest10Result() {
    return CODE(
...
std::shared_ptr<ASTNode> expressionTest11Result() {
    return CODE(
...
std::shared_ptr<ASTNode> expressionTest12Result() {
    return CODE(
...
std::shared_ptr<ASTNode> expressionTest13Result() {
    return CODE(
            ASSIGNVAR("g",
            SUB(
            SUB(INT(10), INT(3)),
...
std::shared_ptr<ASTNode> expressionTest14Result() {
    return CODE(
            ASSIGNVAR("h",
            MULT(
            DIV(INT(8), INT(4)),
...
std::shared_ptr<ASTNode> expressionTest15Result() {
    return CODE(
            ASSIGNVAR("i",
            LEQ(
                VAR("a"),
...
std::shared_ptr<ASTNode> expressionTest16Result() {
    return CODE(
            ASSIGNVAR("j",
            EQ(
            EQ(VAR("x"), VAR("y")),
...
std::shared_ptr<ASTNode> expressionTest17Result() {
    return CODE(
            ASSIGNVAR("k",
            OR(
            VAR("p"),
...
std::shared_ptr<ASTNode> expressionTest18Result() {
    return CODE(
            ASSIGNVAR("l",
            OR(
            OR(VAR("u"), VAR("v")),
...
std::shared_ptr<ASTNode> expressionTest19Result() {
    return CODE(
            ASSIGNVAR("m",
            NOT(
            ASSIGNVAR("x", VAR("y"))
...
std::shared_ptr<ASTNode> expressionTest20Result() {
    return CODE(
            ASSIGNVAR("n",
            NOT(
            EQ(
...
std::shared_ptr<ASTNode> expressionTest21Result() {
    return CODE(
            ASSIGNVAR("a",
            ASSIGNVAR("b", VAR("c"))
        )
...
std::shared_ptr<ASTNode> expressionTest22Result() {
    return CODE(
            FUNC("check", STRARR("x"),
            CODE(
                IF(
...
std::shared_ptr<ASTNode> expressionTest23Result() {
    return CODE(
...
std::shared_ptr<ASTNode> expressionTest24Result() {
    return CODE(
            FUNC("test", STRARR("x"),
            CODE(
                IF(
...
std::shared_ptr<ASTNode> expressionTest25Result() {
    return CODE(
...
std::shared_ptr<ASTNode> expressionTest26Result() {
    return CODE(
            FUNC("nested", STRARR(),
            CODE(
                FUNC("inner", STRARR(),
...
std::shared_ptr<ASTNode> expressionTest27Result() {
    return CODE(
            FUNC("greet", STRARR(),
            CODE(
                RETURN(
...
std::shared_ptr<ASTNode> expressionTest28Result() {
    return CODE(
...
std::shared_ptr<ASTNode> expressionTest29Result() {
    return CODE(
            FUNC("nest", STRARR("a"),
            CODE(
                RETURN(
...
std::shared_ptr<ASTNode> expressionTest30Result() {
    return CODE(
            FUNC("chain", STRARR("a"),
            CODE(
                RETURN(
...
std::shared_ptr<ASTNode> expressionTest31Result() {
    return CODE(
            FUNC("check", STRARR("x"),
            CODE(
                RETURN(
...
std::shared_ptr<ASTNode> expressionTest32Result() {
    return CODE(
            FUNC("neg", STRARR("x"),
            CODE(
                RETURN(
...
std::shared_ptr<ASTNode> expressionTest33Result() {
    return CODE(
            FUNC("outer", STRARR(),
            CODE(
                RETURN(
